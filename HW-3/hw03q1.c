/* *
* (Converts a list of strings into an array of pointers, encrypts the strings, decrypts the strings, and reverses the strings, then asks if a string is a palindrome or not)
*
...
{
	char *p = s;
	//int palindrome = 1;			// edit if needed (redunant code, just return 0 or 1)
	char *q = s + strlen(s) - 1;
